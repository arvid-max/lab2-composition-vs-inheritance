...
public abstract class Car implements Movable {
    ...
    private CarTransport carTransport; // The car that is loading this car, may be null
    ...
    public void gas(double amount){
        if (carTransport != null) throw new IllegalArgumentException("Cannot gas while on a car transport");
    ...
    public Car getCarTransport() {
        return carTransport;
    }
    public void setCarTransport(CarTransport carTransport) {
        this.carTransport = carTransport;
    }
    public void resetCarTransport() {
        carTransport = null;
    }
    public void followCarTransport() {
        if (carTransport != null) {
            setPosition(carTransport.getX(), carTransport.getY());
        }
    }
