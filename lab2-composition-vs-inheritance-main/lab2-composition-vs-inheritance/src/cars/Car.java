...
public abstract class Car implements Movable {
    ...
    public void startEngine(){
        if (!canDrive) throw new IllegalArgumentException("Cannot gas while on a car transport");
        currentSpeed = 0.1;
    }
    ...
    public void gas(double amount){
        if (!canDrive) throw new IllegalArgumentException("Car cannot gas");
    ...
    public void setCanDrive(boolean x) {
        canDrive = x;
    }
